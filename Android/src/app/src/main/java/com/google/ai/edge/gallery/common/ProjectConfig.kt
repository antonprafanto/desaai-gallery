...
object ProjectConfig {
  ...
  // TODO: Replace with real Client ID from https://huggingface.co/settings/applications
  const val clientId = "placeholder-client-id"
  ...
  // "build.gradle.kts".
  const val redirectUri = "aiEdgeGallery://oauth2redirect"
